...
3.README.md和index.html:为什么这两个要同时说呢?因为如果没有index.html，那么默认地就用README.md的内容充当首页，除非你在_config.yml里面设置，如果没有设置，而index.html存在，那么index.html就会取代README.md作为首页。我们有时候需要给项目本身留一个README.md，就不能让他作为首页，所以就得另外开一个index.html取代README.md作为首页，而README.md就完成项目描述职责就好了
