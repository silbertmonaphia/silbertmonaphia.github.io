...
# 前言
  前面的一篇文章写了下[数据库设计和SQL语句基础](https://silbertmonaphia.github.io/db/2016/11/20/%E6%95%B0%E6%8D%AE%E5%BA%93%E8%AE%BE%E8%AE%A1%E5%92%8CSQL%E8%AF%AD%E5%8F%A5%E5%9F%BA%E7%A1%80.html)，里面都是简单的增删改查，而且对最重要的**查询(Retrieve)**也没有深入研究，实在是罪过，那么本文就sql复杂的查询语句进行探讨，也是当作一个记录好了  
  
  18.1.9更新:  
  推荐一本书:[SQL学习指南](https://book.douban.com/subject/4872454/)，之前那篇文章还是不太全面，而且更多也只是停留在独立相对没有那么复杂的SQL上，而这一本则是更加全面地SQL扫盲，教你如何组合你的SQL  
