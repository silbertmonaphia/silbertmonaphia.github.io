...
P.s.职场新人软技能
1.问问题带解决方案，不管多烂，至少要有两个;
2.自己上网搜过之后才是问同事;
3.公司雇佣你来是为了解决问题，即便有安排人带你，带你的人也是只想花最少时间，所以唯一的依靠就是"自学能力";
4.发现问题「效率优化和流程优化」两方面，同样地附上解决方案
5.有条理，逻辑地沟通，最怕因为害怕汇报和沟通，没有及时寻求帮助和支持，最后耽误进度;
6.谁都不喜欢"挤牙膏"式沟通;
7.请教问题请在沟通软件上先预约，而不是突然抱着电脑出现在别人身后请教问题;
8.任何时候都不要迟到，哪怕是弹性工作制;「弹性只是对于牛人而言的」
9.发现效率低下，可以停下来花点时间分析下效率低下原因在哪里
10.没有什么问题是不能通过"独立思考"和"学习"解决的
...
## 考核评价  
安排好了任务以后当然就是需要跟进每个人的完成情况，包括是否按时按质交付等等，而且考核评估也是必须的，因为毕竟是“分赃“的依据。而这个过程也是不断了解每个组员各方面特质的重要途径  
...
* Review粒度(时间越充分越往下面的阶段进行，但至少覆盖第一到第三阶段)
  * 第一阶段：「目录」目录结构是否合理；
  * 第二阶段：「命名」文件、类、方法、函数、变量命名是否符合规范，是否见名知意，是否符合业务领域命名习惯；
  * 第三阶段：「注释-风格」注释是否简洁直观，代码风格是否和原项目规范保持一致；
