...
## 年终汇报
PPT先弄文字版确保没有遗漏，再精炼删减后转化为PPT，PPT内容都通过图表展示，减少文字量，才能留着audience的注意力，PPT的特点就是抓大放小，和1个小时电影的台词文本其实没有多少是一个道理，但是你还是觉得电影精彩。  

完成ppt以后还要预演一次估计时间，然后休息好不然讲解的时候会没有足够精力演绎  
...
第2次修订:  
1.游戏概况统计数据转成了柱状图;  
2.纯文字的做了图状分类(分别是P43,P44,P50,P51页)  
3.增加了事故页;  
4.排版美化调整  
